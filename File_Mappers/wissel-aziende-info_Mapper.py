...
def mapper(mediated_schema_columns): 
    data = DataframeExtractor.extract_dataframe_by_extension("Files/wissel-aziende-info-clipper.com.csv")
    ...
    mediated_df["Trade Name"] = data["Trade Name"]
    mediated_df["Headquarters Address"] = data["Address Name"]
    mediated_df["Headquarters City"] = data["City"]
    mediated_df["Headquarters Region"] = data["State"]
    mediated_df["Headquarters Country"] = data["Country"]
    mediated_df["Postalcode"] = data["Postalcode"]
